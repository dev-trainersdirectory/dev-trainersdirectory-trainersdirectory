...
$route['email_templates'] = "admin/cadminemailtemplatescontroller";
$route['email_templates/(.*)'] = "admin/cadminemailtemplatescontroller/$1";
...
$route['admin_bulk_upload'] = "admin/cadminbulkuploadcontroller";
