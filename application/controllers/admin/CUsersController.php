...
class CUsersController extends CI_Controller {

	public function index() {

		$arrObjLeads = CLeads::fetchAllLeads();

		$arrMixAssignData['arrObjLeads'] = $arrObjLeads;

		$this->load->view( 'admin/view_leads', $arrMixAssignData );
	}
